var UserSQL = {
  ...
  getCourseByTitle: 'SELECT t_course.cID ID, cName title, cCover cover, cInfo info, v_coursesourcecount.sectionCount FROM t_course, v_coursesourcecount WHERE t_course.cID = v_coursesourcecount.cID AND cName LIKE concat(\'%\', ?, \'%\')',
